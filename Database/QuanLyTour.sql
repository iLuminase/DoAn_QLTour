...
--Insert dữ liệu
INSERT INTO Tour (TenTour, LichTrinh, GiaTien, MoTa, NgayBatDau, NgayKetThuc, TinhTrang)
VALUES
(N'Tour Hà Nội - Hạ Long', N'Lịch trình tham quan Hà Nội và Vịnh Hạ Long trong 4 ngày', 8000000, N'Tour du lịch khám phá thủ đô và di sản thiên nhiên', '2024-11-01', '2024-11-04', 1 ),
(N'Tour Đà Lạt - Thung Lũng Tình Yêu', N'Lịch trình Đà Lạt trong 3 ngày', 5000000, N'Tour tham quan cảnh đẹp Đà Lạt', '2024-11-10', '2024-11-12',1 ),
(N'Tour Phú Quốc', N'Lịch trình khám phá đảo Phú Quốc trong 5 ngày', 10000000, N'Tour nghỉ dưỡng tại Phú Quốc', '2024-12-01', '2024-12-05',1 ),
(N'Tour Sapa - Fansipan', N'Lịch trình chinh phục Fansipan trong 4 ngày', 9000000, N'Tour khám phá Sapa và đỉnh Fansipan', '2024-11-15', '2024-11-18',1 ),
(N'Tour Nha Trang', N'Lịch trình khám phá bãi biển Nha Trang trong 3 ngày', 7000000, N'Tour nghỉ dưỡng biển tại Nha Trang', '2024-11-20', '2024-11-22',1 ),
(N'Tour Huế - Đà Nẵng', N'Lịch trình tham quan cố đô Huế và Đà Nẵng trong 4 ngày', 8500000, N'Tour khám phá di sản văn hóa Huế và thành phố biển Đà Nẵng', '2024-12-05', '2024-12-08',1 ),
(N'Tour Hội An - Mỹ Sơn', N'Lịch trình khám phá Hội An và Thánh địa Mỹ Sơn trong 3 ngày', 6000000, N'Tour văn hóa lịch sử tại Hội An và Mỹ Sơn', '2024-11-25', '2024-11-27',1 ),
(N'Tour Cần Thơ - Chợ nổi Cái Răng', N'Lịch trình khám phá miền Tây trong 2 ngày', 4000000, N'Tour du lịch miền Tây và chợ nổi Cái Răng', '2024-11-28', '2024-11-29',1 ),
(N'Tour Bình Thuận - Mũi Né', N'Lịch trình nghỉ dưỡng tại Mũi Né trong 3 ngày', 6000000, N'Tour khám phá biển và đồi cát Mũi Né', '2024-12-01', '2024-12-03',1 ),
(N'Tour Vũng Tàu', N'Lịch trình nghỉ dưỡng tại Vũng Tàu trong 2 ngày', 3500000, N'Tour tham quan thành phố biển Vũng Tàu', '2024-12-10', '2024-12-11',1 ),
(N'Tour Quảng Bình - Hang Sơn Đoòng', N'Lịch trình khám phá hang động lớn nhất thế giới Sơn Đoòng trong 7 ngày', 25000000, N'Tour khám phá Sơn Đoòng và vườn quốc gia Phong Nha', '2024-12-15', '2024-12-21',1 ),
(N'Tour Hà Giang - Cao nguyên đá Đồng Văn', N'Lịch trình khám phá cao nguyên đá Hà Giang trong 5 ngày', 12000000, N'Tour tham quan cảnh đẹp Hà Giang', '2024-12-01', '2024-12-05',1 ),
(N'Tour Côn Đảo', N'Lịch trình khám phá di tích lịch sử và biển Côn Đảo trong 4 ngày', 11000000, N'Tour lịch sử và nghỉ dưỡng tại Côn Đảo', '2024-12-25', '2024-12-28',1 ),
(N'Tour Đà Nẵng - Bà Nà Hills', N'Lịch trình tham quan Đà Nẵng và Bà Nà Hills trong 3 ngày', 7500000, N'Tour khám phá thành phố biển Đà Nẵng và Bà Nà Hills', '2024-12-20', '2024-12-22',1 ),
(N'Tour Phan Thiết - Làng Chài', N'Lịch trình khám phá Phan Thiết và làng chài trong 3 ngày', 5500000, N'Tour du lịch biển và văn hóa Phan Thiết', '2024-11-05', '2024-11-07',1 ),
(N'Tour Pleiku - Gia Lai', N'Lịch trình khám phá vùng cao Pleiku trong 4 ngày', 6500000, N'Tour tham quan vùng cao nguyên Tây Nguyên', '2024-11-10', '2024-11-13',1 ),
(N'Tour Đắk Lắk - Buôn Ma Thuột', N'Lịch trình khám phá Buôn Ma Thuột trong 3 ngày', 7000000, N'Tour khám phá văn hóa và thiên nhiên Buôn Ma Thuột', '2024-12-05', '2024-12-07',1 ),
(N'Tour Nam Định - Tràng An', N'Lịch trình khám phá danh thắng Tràng An trong 3 ngày', 5000000, N'Tour tham quan di sản Tràng An', '2024-11-17', '2024-11-19',1 ),
(N'Tour Lào Cai - Chợ Bắc Hà', N'Lịch trình khám phá chợ Bắc Hà và Sapa trong 4 ngày', 8500000, N'Tour khám phá văn hóa dân tộc vùng cao', '2024-11-12', '2024-11-15',1 ),
(N'Tour Tây Ninh - Núi Bà Đen', N'Lịch trình leo núi và khám phá Tây Ninh trong 2 ngày', 3000000, N'Tour leo núi và khám phá văn hóa Tây Ninh', '2024-12-01', '2024-12-02',1 )
GO
...
VALUES
(N'Nguyễn Văn Thanh', N'Quản lý', N'0901122334', N'nguyen.thanh@congty.com', N'Hà Nội', '1985-05-20', N'011223344', 1),
(N'Trần Thị Hồng', N'Nhân viên kinh doanh', N'0912233445', N'tran.hong@congty.com', N'Đà Nẵng', '1990-07-15', N'022334455', 1),
(N'Hoàng Văn Nam', N'Hướng dẫn viên', N'0923344556', N'hoang.nam@congty.com', N'TP Hồ Chí Minh', '1988-09-10', N'033445566', 1),
(N'Võ Thị Bích', N'Nhân viên kế toán', N'0934455667', N'vo.bich@congty.com', N'Huế', '1992-02-18', N'044556677', 1),
(N'Lê Văn Toàn', N'Hướng dẫn viên', N'0945566778', N'le.toan@congty.com', N'Nha Trang', '1987-11-25', N'055667788', 1),
(N'Phạm Thị Lan', N'Quản lý', N'0956677889', N'pham.lan@congty.com', N'Phú Quốc', '1995-03-30', N'066778899', 1),
(N'Ngô Minh Sơn', N'Nhân viên kinh doanh', N'0967788990', N'ngo.son@congty.com', N'Sapa', '1986-08-05', N'077889900', 1),
(N'Bùi Thị Nga', N'Nhân viên lễ tân', N'0978899001', N'bui.nga@congty.com', N'Cần Thơ', '1991-06-12', N'088990011', 1),
(N'Trịnh Văn Hải', N'Nhân viên bán vé', N'0989900112', N'trinh.hai@congty.com', N'Vũng Tàu', '1989-01-23', N'099100122', 1),
(N'Vũ Thị Hương', N'Quản lý', N'0900011223', N'vu.huong@congty.com', N'Hà Giang', '1984-04-16', N'100111223', 1),
(N'Đỗ Thị Thủy', N'Nhân viên lễ tân', N'0911122334', N'do.thuy@congty.com', N'Hà Nội', '1993-12-20', N'111122334', 1),
(N'Phan Quốc Định', N'Nhân viên bán vé', N'0922233445', N'phan.dinh@congty.com', N'Đà Lạt', '1990-08-22', N'122233445', 1),
(N'Tô Thị Bích', N'Quản lý', N'0933344556', N'to.bich@congty.com', N'Pleiku', '1983-10-13', N'133344556', 1),
(N'Lý Minh Cường', N'Hướng dẫn viên', N'0944455667', N'ly.cuong@congty.com', N'Hải Phòng', '1989-07-17', N'144455667', 1),
(N'Phạm Văn Hải', N'Nhân viên kinh doanh', N'0955566778', N'pham.hai@congty.com', N'Quảng Bình', '1994-02-07', N'155566778', 1),
(N'Trần Thị Thanh', N'Nhân viên bán vé', N'0966677889', N'tran.thanh@congty.com', N'Tây Ninh', '1992-01-19', N'166677889', 1),
(N'Võ Minh Tuấn', N'Nhân viên lễ tân', N'0977788990', N'vo.tuan@congty.com', N'Buôn Ma Thuột', '1991-06-09', N'177788900', 1),
(N'Lê Thị Ngọc', N'Nhân viên kế toán', N'0988899001', N'le.ngoc@congty.com', N'Bình Thuận', '1988-09-11', N'188899011', 1),
(N'Nguyễn Văn Sơn', N'Quản lý', N'0900011223', N'nguyen.son@congty.com', N'Tây Ninh', '1993-03-03', N'199900122', 1),
(N'Trần Thị Mai', N'Hướng dẫn viên', N'0911122334', N'tran.mai@congty.com', N'Côn Đảo', '1986-05-28', N'200111223', 1)
GO
...
VALUES
(N'Khuyến mãi mùa đông', '2024-12-01', '2024-12-31', 15, 10),
(N'Khuyến mãi lễ 30/4', '2024-04-01', '2024-04-30', 10, 10),
(N'Giảm giá mùa hè', '2024-06-01', '2024-07-31', 20, 10),
(N'Khuyến mãi cuối năm', '2024-12-15', '2024-12-31', 25, 10),
(N'Giảm giá dịp Noel', '2024-12-20', '2024-12-25', 10, 10),
(N'Khuyến mãi Tết nguyên đán', '2025-01-01', '2025-02-15', 30, 10),
(N'Giảm giá Black Friday', '2024-11-24', '2024-11-28', 40, 10),
(N'Khuyến mãi lễ 2/9', '2024-08-25', '2024-09-05', 20, 10),
(N'Giảm giá tháng 5', '2024-05-01', '2024-05-31', 15, 10),
(N'Giảm giá tháng 11', '2024-11-01', '2024-11-30', 10, 10),
(N'Giảm giá tháng 7', '2024-07-01', '2024-07-31', 15, 10),
(N'Khuyến mãi Trung Thu', '2024-09-15', '2024-09-30', 20, 10),
(N'Khuyến mãi lễ Quốc Khánh', '2024-09-01', '2024-09-05', 10, 10),
(N'Giảm giá tháng 10', '2024-10-01', '2024-10-31', 20, 10),
(N'Giảm giá tháng 9', '2024-09-01', '2024-09-30', 15, 10),
(N'Khuyến mãi dịp Valentine', '2025-02-10', '2025-02-15', 10, 10),
(N'Khuyến mãi ngày 8/3', '2025-03-01', '2025-03-10', 15, 10),
(N'Khuyến mãi Halloween', '2024-10-25', '2024-10-31', 20, 10),
(N'Khuyến mãi mừng khai trương', '2024-11-01', '2024-11-15', 30, 10),
(N'Khuyến mãi dịp sinh nhật công ty', '2024-08-01', '2024-08-10', 20, 10);

Go
INSERT INTO DatTour (MaKhachHang, MaTour, NgayDat, SoLuongNguoi, TongTien, TinhTrang) 
VALUES 
(1, 1, '2024-10-01', 2, 16000000, N'Chưa thanh toán'),
(2, 2, '2024-10-02', 3, 15000000, N'Đã thanh toán'),
(3, 3, '2024-10-03', 4, 40000000, N'Chưa thanh toán'),
(4, 4, '2024-10-04', 2, 18000000, N'Đã thanh toán'),
(5, 5, '2024-10-05', 1, 7000000, N'Chưa thanh toán'),
(6, 6, '2024-10-06', 3, 25500000, N'Đã thanh toán'),
(7, 7, '2024-10-07', 2, 12000000, N'Chưa thanh toán'),
(8, 8, '2024-10-08', 4, 24000000, N'Đã thanh toán'),
(9, 9, '2024-10-09', 2, 12000000, N'Chưa thanh toán'),
(10, 10, '2024-10-10', 1, 3500000, N'Đã thanh toán'),
(1, 11, '2024-10-11', 3, 7500000, N'Đã thanh toán'),
(2, 12, '2024-10-12', 4, 48000000, N'Chưa thanh toán'),
(3, 13, '2024-10-13', 2, 22000000, N'Đã thanh toán'),
(4, 14, '2024-10-14', 1, 6000000, N'Chưa thanh toán'),
(5, 15, '2024-10-15', 2, 11000000, N'Đã thanh toán'),
(6, 16, '2024-10-16', 3, 19500000, N'Chưa thanh toán'),
(7, 17, '2024-10-17', 4, 28000000, N'Đã thanh toán'),
(8, 18, '2024-10-18', 2, 14000000, N'Chưa thanh toán'),
(9, 19, '2024-10-19', 3, 25500000, N'Đã thanh toán'),
(10, 20, '2024-10-20', 1, 3000000, N'Chưa thanh toán');
GO
